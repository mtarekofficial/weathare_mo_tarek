  ...
  if (resultsOfWeathare.location) {
    ...
    <div class="my-5" >
        ...
        <div class="d-flex justify-content-around py-1">
          <div class="w-50">
            <h2 class="fw-bolder">${resultsOfWeathare.current.temp_c} ْC</h2>
          </div>
          <div class="w-50">
            <i class="fa fa-cloud"></i>
          </div>
        </div>
      <p class="text-info pt-4 pb-1">${resultsOfWeathare.current.condition.text}</p>
...
function displayweathareOfWeathareDayThree() {
  if (resultsOfWeathare.location) {
    ...
    var cartona = `
      ...
      <div class="my-5">
        <i class="fa-solid fa-cloud-sun py-1"></i>
        <h2 class="fw-bolder text-white py-1">${resultsOfWeathare.forecast.forecastday[3].day.avgtemp_c}C</h2>
        <h5 class="fw-bolder text-secondary py-1">${resultsOfWeathare.forecast.forecastday[4].day.avgtemp_c}</h5>
        <p class="text-info">${resultsOfWeathare.forecast.forecastday[3].day.condition.text}</p>
      </div>
    `;
